...
def evaluate_answer(answer):
    ...
    clean = answer.strip().replace(" ", "").replace("呢個係", "").replace("這是", "").replace("隻係", "").replace("個位是", "")
...
if st.session_state.stage == "intro":
    ...
    st.markdown("""
    <div class="instruction-card"><h2>婆婆/伯伯，今日我們要去街市買菜！</h2><p style="font-size:22px;">請睇睇螢幕上的食材，<b>用廣東話講出它的名字</b>。</p><p style="font-size:18px;color:#555;">(例如說：「呢個係雞」或「八爪魚」)</p></div>
    """, unsafe_allow_html=True)
    ...
    st.balloons(); st.title("🎉 買菜完成！感謝您的幫忙！")
